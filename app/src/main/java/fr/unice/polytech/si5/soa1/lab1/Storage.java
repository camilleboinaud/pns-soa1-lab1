package main.java.fr.unice.polytech.si5.soa1.lab1;

import main.java.fr.unice.polytech.si5.soa1.lab1.business.StorableContent;
import main.java.fr.unice.polytech.si5.soa1.lab1.utils.ContentType;
...
public class Storage {
    ...
    private static HashMap<ContentType, Map<Integer, StorableContent>> database = new HashMap<>();
    ...
    public Collection<StorableContent> findAll(ContentType type){
